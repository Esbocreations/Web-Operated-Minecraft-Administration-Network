...
<package packagerversion="1.8.0" version="2.0" xmlns="http://pear.php.net/dtd/package-2.0"
  ...
  <description>
    Swift Mailer integrates into any web app written in PHP 5, offering a flexible and elegant object-oriented approach
    to sending emails with a multitude of features.
  </description>
  <lead>
